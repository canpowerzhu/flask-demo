...
class ProjectInfoSchema(Schema):
    ...
    health_check_interval = fields.Integer(validate.Range(min=10,max=60),error_messages={"health_check_interval the value range is  between 10 and 60, the unit is (s) "})
    health_check_retries = fields.Integer(validate.Range(min=3,max=5),error_messages={"health_check_interval the value range is  between 3 and 5 "})
    health_check_start_period = fields.Integer(validate.Range(min=60,max=120),error_messages={"health_check_interval the value range is  between 60 and 120,the unit is (s) "})
