...
def login():
    if request.method == "POST":
        ...
        if status:
            logger.info("登陆验证成功，create_access_token: {},create_refresh_token: {} ".format(
                create_access_token(identity=email_username), create_refresh_token(identity=email_username)))
