...
def get_all_bucket() -> list:
    ...
    return [{'bucket_name': oss_item.name, 'region_id': oss_item.location[4::],
             'extranet_endpoint': oss_item.extranet_endpoint, 'intranet_endpoint': oss_item.intranet_endpoint} for
            oss_item in oss2.BucketIterator(oss_list_client)]
